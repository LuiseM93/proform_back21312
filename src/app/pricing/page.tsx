      ...
      <main className="flex-grow pt-16 pb-16 px-4 md:px-margin-lg max-w-screen-2xl mx-auto w-full">
        <section className="text-center mb-16 max-w-3xl mx-auto">
          ...
          <div className="flex items-center justify-center gap-2 mt-6">
            ...
            <span className="font-label-md flex items-center gap-1">
              Annually
              <span className="bg-secondary/10 text-secondary px-2 py-0.5 rounded text-xs font-bold ml-2">
                Save 20%
              </span>
            </span>
          </div>
        ...
        <section className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-16">
          <div className="border border-outline-variant p-8 flex flex-col rounded bg-surface h-full">
            <div className="mb-4">
              ...
              <div className="font-headline-md mb-2">
                $0<span className="font-body-md text-on-surface-variant">/mo</span>
              </div>
              <p className="font-body-md text-on-surface-variant h-12">
                Perfect for individuals starting with global trade.
              </p>
            </div>
            <ul className="flex-grow space-y-3 mb-8">
              <li className="flex items-start gap-2">
                <span className="material-symbols-outlined text-outline text-sm">check</span>
                <span className="font-body-md">3 docs/month</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="material-symbols-outlined text-outline text-sm">check</span>
                <span className="font-body-md">Watermarked PDFs</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="material-symbols-outlined text-outline text-sm">check</span>
                <span className="font-body-md">Proforma invoices only</span>
              </li>
              <li className="flex items-start gap-2 text-outline">
                <span className="material-symbols-outlined text-sm">close</span>
                <span className="font-body-md">No carrier-ready PDFs</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="material-symbols-outlined text-outline text-sm">check</span>
                <span className="font-body-md">Community support</span>
              </li>
            </ul>
            <Link
              href="/register?plan=starter"
              className="w-full text-center border border-primary text-primary font-label-md py-3 rounded hover:bg-surface-container-low transition-colors"
            >
              Start Free
            </Link>
          </div>
          ...
          <div className="border-2 border-primary p-8 flex flex-col rounded bg-surface relative shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] md:-translate-y-2">
            <div className="absolute top-0 right-0 bg-primary text-on-primary px-3 py-1 font-label-md text-xs font-bold rounded-bl">
              Popular
            </div>
            <div className="mb-4">
              ...
              <div className="font-headline-md mb-2">
                ${plan.pro}
                <span className="font-body-md text-on-surface-variant">{plan.proSuffix}</span>
                {annual && (
                  <div className="text-xs text-on-surface-variant mt-1 font-body-md font-normal">
                    Billed $228 yearly
                  </div>
                )}
              </div>
              <p className="font-body-md text-on-surface-variant h-12">
                For growing businesses needing carrier integration.
              </p>
            </div>
            <ul className="flex-grow space-y-3 mb-8">
              {[
                ...
                "No watermark",
                "All document types",
                "Carrier-ready PDFs (FedEx/UPS/DHL)",
                "50 document history",
                "5 currencies",
                "Email support",
              ].map((f) => (
                <li key={f} className="flex items-start gap-2">
                  ...
                  <span className="font-body-md font-medium">{f}</span>
                </li>
              ))}
            </ul>
            <Link
              href="/register?plan=professional"
              className="w-full text-center bg-primary text-on-primary font-label-md py-3 rounded hover:opacity-90 transition-opacity"
            >
              Get Professional
            </Link>
          </div>
          ...
          <div className="border border-outline-variant p-8 flex flex-col rounded bg-surface h-full">
            <div className="mb-4">
              ...
              <div className="font-headline-md mb-2">
                ${plan.biz}
                <span className="font-body-md text-on-surface-variant">{plan.bizSuffix}</span>
                {annual && (
                  <div className="text-xs text-on-surface-variant mt-1 font-body-md font-normal">
                    Billed $758 yearly
                  </div>
              ...
              <p className="font-body-md text-on-surface-variant h-12">
                Advanced features for high-volume operations.
              </p>
            </div>
            <ul className="flex-grow space-y-3 mb-8">
              {[
        ...
        <p className="text-center font-label-md text-on-surface-variant mb-16">
          * $4/document for Starter users exceeding the monthly limit.
        </p>
          ...
          <table className="w-full text-left border-collapse min-w-[600px]">
            <thead>
              <tr className="border-b-2 border-primary">
                ...
                <th className="py-3 px-4 font-label-md w-1/4 text-center bg-surface-container-low">
                  Professional
                </th>
            ...
            <tbody className="font-body-md">
              <tr className="border-b border-outline-variant">
                ...
                <td className="py-3 px-4 text-center bg-surface-container-low font-medium">
                  Unlimited
                </td>
              ...
              <tr className="border-b border-outline-variant">
                ...
                <td className="py-3 px-4 text-center bg-surface-container-low">
